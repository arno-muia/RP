  ...
  return (
    <section className="register-parchment section-padding">
      <ScrollReveal className="mx-auto max-w-4xl px-5 text-center md:px-8">
        ...
        <p className="mt-6 font-semibold text-primary">— Our Vision</p>
      </ScrollReveal>

      <ScrollReveal className="mx-auto mt-16 max-w-4xl px-5 text-center md:px-8">
        <blockquote className="text-lg leading-relaxed text-foreground md:text-xl">
          &ldquo;{welcome.message}&rdquo;
        </blockquote>
        <p className="mt-6 font-semibold text-primary">— Our Mission</p>
      </ScrollReveal>
    </section>
  );
}
