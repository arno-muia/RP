    ...
    <>
      ...
      <section className="register-celestial section-padding">
        <div className="prose prose-stone mx-auto max-w-3xl px-5 md:px-8">
          ...
          <h2 className="font-display mt-8 text-2xl uppercase text-primary">Acceptance</h2>
          <p className="mt-4 text-muted-foreground">
            By accessing and using the {site.name} website, you accept and agree to be
            bound by these Terms of Service.
          </p>

          <h2 className="font-display mt-8 text-2xl uppercase text-primary">Use of Content</h2>
          <p className="mt-4 text-muted-foreground">
          ...
          <h2 className="font-display mt-8 text-2xl uppercase text-primary">User Submissions</h2>
          <p className="mt-4 text-muted-foreground">
          ...
          <h2 className="font-display mt-8 text-2xl uppercase text-primary">Disclaimer</h2>
          <p className="mt-4 text-muted-foreground">
