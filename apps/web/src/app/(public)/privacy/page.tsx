    ...
    <>
      ...
      <section className="section-padding register-celestial bg-white">
        <div className="prose prose-stone mx-auto max-w-3xl px-5 md:px-8">
          ...
          <h2 className="font-display mt-8 text-2xl uppercase text-burgundy">Introduction</h2>
          ...
          <h2 className="font-display mt-8 text-2xl uppercase text-burgundy">Data We Collect</h2>
          ...
          <h2 className="font-display mt-8 text-2xl uppercase text-burgundy">How We Use Your Data</h2>
          <ul className="mt-4 list-disc space-y-2 pl-6 text-muted">
          ...
          <h2 className="font-display mt-8 text-2xl uppercase text-burgundy">Your Rights</h2>
          <p className="mt-4 text-muted">
            ...
            <a href={`mailto:${site.contact.email}`} className="text-burgundy">
              {site.contact.email}
            </a>{" "}
